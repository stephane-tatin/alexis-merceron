...
export const assets: Data[] = [
	{
		...
		path: 'situation-geopolitique',
		texts: [
			'Au début du XXème siècle, l’Europe est partagée entre démocraties libérales, comme la France et le Royaume-Uni, et empires aux régimes plus ou moins autoritaires, comme l’Allemagne, L’Autriche-Hongrie ou la Russie. De fortes rivalités économiques et territoriales, combinées à un puissant nationalisme, encouragent et légitiment le recours à la violence pour défendre et étendre l’intérêt des états.',
			'L’Empire austro-hongrois lutte contre des revendications nationalistes qui menacent son unité. La Russie se voit comme la protectrice des populations slaves, et l’utilise comme prétexte pour étendre son influence. L’Allemagne, arrivée tard dans la course aux colonies, se sent lésée dans le partage du monde. L’Italie convoite des territoires appartenant à l’Autriche-Hongrie. La France cherche à prendre sa revanche après avoir dû céder l’Alsace-Lorraine en 1871. La Grande Bretagne, puissance mondiale dominante, souhaite préserver cet équilibre.',
		...
		images: [
			{
				title: "Carte de l'Europe - 1914",
				desc: "Carte de l'Europe - 1914",
			...
			},
			{
				...
				desc: 'Die Zeit - 28 septembre 1914',
			...
			},
			{
				...
				desc: 'Berliner Tageblatt - 2 Août 1914',
			...
			},
			{
				...
				desc: 'Le Petit parisien - 3 Août 1914',
			...
			},
			{
				...
				desc: 'Daily Express - 4 août 1914',
		...
		links: [
			{
				desc: "L'Europe à la veille de la guerre",
				url: 'https://essentiels.bnf.fr/fr/histoire/20e-siecle/23183553-a0a4-44d8-b7f0-e6d6aec91db8-grande-guerre/article/df42c3b1-f364-4282-bbb0-47ce971a79f8-europe-la-veille-la-guerre'
			},
			{
				desc: 'La guerre inimaginable',
				url: 'https://essentiels.bnf.fr/fr/histoire/20e-siecle/23183553-a0a4-44d8-b7f0-e6d6aec91db8-grande-guerre/article/3ffa5c7b-5f7f-4cd2-9587-621b205a7237-guerre-inimaginable'
			}
		]
	},
	{
		...
		texts: [
			...
			'Au début du mois de mai 1915, l’état-major souhaite réinjecter du mouvement dans cette guerre de position, l’opinion publique souhaite voir les territoires occupés au Nord-est libérés. Le généralissime Joffre planifie alors une attaque de grande ampleur pour forcer l’Allemagne à une retraite : la seconde bataille d’Artois, déclenchée le 9 mai 1915.'
		],
		images: [
			{
				title: 'Message du président de la République, 4 août 1914',
		...
		links: [
			{
				desc: 'Situation démographique - 1914',
				url: 'https://www.cheminsdememoire.gouv.fr/fr/1914-une-france-demographiquement-affaiblie'
			}
		]
	},
	{
		...
		images: [
			{
				title: 'La route de Carency à Souchez - 1915',
				desc: 'La Guerre 1914-15 - Carency (P.-de-C.) - La route de Carency à Souchez. Archives départementales du Pas-de-Calais, 5 Fi 213/7.',
			...
			},
			{
				...
				desc: 'La Grande Guerre 1914-15. Un poste français à Carency (P.-de-C.). Archives départementales du Pas-de-Calais, 5 Fi 213/013.',
			...
			},
			{
				...
				desc: 'Carte des combats autour de Carency, Souchez et Neuville-Saint-Vaast (9-20 mai 1915)',
			...
			},
			{
				...
				desc: 'Disposition des divisions - 16 juin 1915',
			...
			},
			{
				...
				desc: "La Grande Guerre 1914-1915 - Le village d'Ablain après la bataille de juin de 1915. Archvies départementales du Pas-de-Calais, 5 Fi 01/064.",
		...
		links: [
			{
				desc: "Début de la deuxième bataille d'Artois - 9 mai 1915",
				url: 'https://www.archivespasdecalais.fr/Decouvrir/Chroniques-de-la-Grande-Guerre/Histoires-de-la-Grande-Guerre/Debut-de-la-deuxieme-bataille-d-Artois'
			},
			{
	...
	{
		id: 4,
		title: "32ème Régiment d'infanterie",
		path: '32-reg',
		texts: [
			...
			'Sélectionné pour la grande offensive d’Artois planifiée par le général Joffre, le régiment est placé vers la ville de Souchez, avec pour objectif de prendre la côte 140. Le 16 juin, après plusieurs assauts infructueux, une offensive de grande ampleur est donnée.'
		],
		images: [
			{
				title: 'Arrivée au corps - décembre 1914',
				desc: 'desc carte',
		...
		links: [
			{
				desc: "Ce que nous avons fait, historique du 32e régiment d'infanterie pendant la campagne 1914-1919",
				url: 'https://gallica.bnf.fr/ark:/12148/bpt6k62270487/f9.item.texteImage.zoom'
			},
			{
				desc: 'J.M.O. - 5 août 1914-31 décembre 1916 - 26 N 605/12',
				url: 'https://www.memoiredeshommes.sga.defense.gouv.fr/conflits-et-operations-2/premiere-guerre-mondiale/journaux-des-unites-engagees-dans-la-premiere-guerre-mondiale/faire-une-recherche?arko_default_66b0ee3a6d947--ficheFocus=arko_fiche_669e82321c396&arko_default_66b0ee3a6d947--filtreGroupes%5Bmode%5D=simple&arko_default_66b0ee3a6d947--filtreGroupes%5Bop%5D=AND&arko_default_66b0ee3a6d947--filtreGroupes%5Bgroupes%5D%5B0%5D%5Barko_default_66b0f16c2c11a%5D%5Bop%5D=AND&arko_default_66b0ee3a6d947--filtreGroupes%5Bgroupes%5D%5B0%5D%5Barko_default_66b0f16c2c11a%5D%5Bq%5D%5B%5D=32%20R%C3%A9giment&arko_default_66b0ee3a6d947--filtreGroupes%5Bgroupes%5D%5B0%5D%5Barko_default_66b0f16c2c11a%5D%5Bextras%5D%5Bmode%5D=input&arko_default_66b0ee3a6d947--from=0&arko_default_66b0ee3a6d947--resultSize=25&arko_default_66b0ee3a6d947--contenuIds%5B%5D=6819949&arko_default_66b0ee3a6d947--modeRestit=arko_default_66b0f26be2b60#/_recherche-api/visionneuse-infos/arko_default_66b0ee3a6d947/arko_fiche_669e82321c396/arko_default_66b0f1f0a88b1/image/21936'
			}
		]
	},
	{
		...
		links: [
			{
				desc: 'Généalogie',
				url: 'https://gw.geneanet.org/mtatin?n=merceron&oc=&p=louis+honore+alexis&type=fiche'
			},
			{
				desc: 'Nécropole nationale Notre Dame de Lorette',
				url: 'https://fr.geneawiki.com/wiki/N%C3%A9cropole_nationale_Notre_Dame_de_Lorette_-_M'
			}
		]
	}
];
