...
export const assets: Data[] = [
	{
		...
		texts: [
			'Au début du XXème siècle, l’Europe est au centre du monde. Elle est partagée entre démocraties libérales, comme la France et le Royaume-Uni, et empires plus ou moins autoritaires, comme l’Allemagne, L’Autriche-Hongrie ou la Russie. La suprématie économique et intellectuelle, ainsi qu’un nationalisme élevé, servent souvent de justifications à l’usage de la violence.',
