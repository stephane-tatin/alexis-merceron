...
export const assets: Data[] = [
	{
		...
		texts: [
			'Au début du XXème siècle, l’Europe est partagée entre démocraties libérales, comme la France et le Royaume-Uni, et empires aux régimes plus ou moins autoritaires, comme l’Allemagne, L’Autriche-Hongrie ou la Russie. La suprématie économique et intellectuelle, ainsi qu’un nationalisme élevé, servent souvent de justifications à l’usage de la violence.',
			'L’Empire austro-hongrois lutte contre des revendications nationalistes qui menacent son unité. La Russie se voit comme la protectrice des populations slaves, et l’utilise comme prétexte pour étendre son influence. L’Allemagne, arrivée tard dans la course aux colonies, se sent lésée dans le partage du monde. L’Italie convoite territoires appartenant à l’Autriche-Hongrie. La France cherche à prendre sa revanche après avoir dû céder l’Alsace-Lorraine en 1871. La Grande Bretagne, puissance mondiale dominante, souhaite préserver cet équilibre.',
